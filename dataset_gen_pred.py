...
if __name__ == '__main__':
    ...
    if modes in ['train', 'val']:
        ...
        for i, id in enumerate(locations):
            print(id)
            satimg_processor.pred_dataset_generator_seqtoseq(mode = 'test', locations=[id], visualize=False, data_path='/home/lsturaro/github/TS-SatFire/ts-satfire',file_name=usecase+'_'+id+'_img_seqtoseql_'+str(ts_length)+'i_'+str(interval)+'.npy', label_name=usecase+'_'+id+'_label_seqtoseql_'+str(ts_length)+'i_'+str(interval)+'.npy',
