...
if __name__ == '__main__':
    ...
    if modes == 'train' or modes == 'val':
        satimg_processor.dataset_generator_seqtoseq(mode=modes, usecase=usecase, data_path='./ts-satfire/', locations=locations, visualize=False, 
        ...
        for id in locations:
            if usecase == 'ba':
                satimg_processor.dataset_generator_seqtoseq(mode = 'test', usecase=usecase, data_path='./ts-satfire/', locations=[id], visualize=False, file_name=usecase+'_'+id+'_img_seqtoseql_'+str(ts_length)+'i_'+str(interval)+'.npy', label_name=usecase+'_'+id+'_label_seqtoseql_'+str(ts_length)+'i_'+str(interval)+'.npy',
                ...
                af_test_processor.af_seq_tokenizing_and_test_slicing(location=id, modes=modes, ts_length=ts_length, interval=interval, usecase=usecase, root_path='./dataset', save_path='./dataset')